    ...
    >
      <div className="flex items-start justify-between mb-4">
        <div>
          ...
          <div className="flex items-center gap-4 text-sm" style={{ color: 'var(--nutritrack-neutral)' }}>
      ...
      <button
        className="w-full px-4 py-2.5 rounded transition-transform hover:scale-105"
        style={{ 
